...
try {
  ...
  if (err.code === "MODULE_NOT_FOUND") {
    err.message += "\n babel-loader@8 requires Babel 7.x (the package '@gerhobbelt/babel-core'). " + "If you'd like to use Babel 6.x ('babel-core'), you should install 'babel-loader@7'.";
  }
...
function _loader() {
  _loader = _asyncToGenerator(function* (source, inputSourceMap, overrides) {
    ...
    if (!babel.loadPartialConfig) {
      throw new Error(`babel-loader ^8.0.0-beta.3 requires @gerhobbelt/babel-core@7.0.0-beta.41, but ` + `you appear to be using "${babel.version}". Either update your ` + `@gerhobbelt/babel-core version, or pin you babel-loader version to 8.0.0-beta.2`);
    }
